...
let loop = true;
let msg = chalk.red("\t---------------------------------------\n\t    Welcome to Ambreen's Word Counter\n\t---------------------------------------");
console.log(msg);
while (loop) {
    ...
    let user = await inquirer.prompt([
        {
            type: "input",
            name: "sentence",
            message: chalk.blueBright(`Please enter a sentence: \n`),
        },
    ]);
    ...
    console.log(chalk.green(`\tThe number of words in the sentence = ${words}. (Letters = ${letters})`));
    //!Quit Function
